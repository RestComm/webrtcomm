...
function connectToRestcomm() {
	var wrtcConfiguration = {
		...
		sip: {
			...
			sipOutboundProxy: 'wss://${restcomm-host}:${restcomm-port}', // CHANGEME: setup your restcomm instance domain/ip and port
			sipDomain: '${restcomm-host}', // CHANGEME: setup your restcomm instance domain/ip
